...
/**
 * The site's components use literal hex Tailwind utilities (e.g. `bg-[#C68A17]`)
 ...
 * `bg-[#C68A17]/30`) are separate classes and keep their original hue.
 */
...
// Escaped arbitrary-value selector fragment, e.g. "#C68A17" -> "\[\#C68A17\]".
