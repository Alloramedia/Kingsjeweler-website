...
export function GlowCard({
  ...
  return (
    ...
    >
      <div className="absolute -inset-0.5 rounded-2xl bg-linear-to-r from-[#C68A17]/0 via-[#C68A17]/0 to-[#C68A17]/0 group-hover:from-[#C68A17]/25 group-hover:via-[#C68A17]/15 group-hover:to-[#C68A17]/0 transition-all duration-600 blur-md opacity-0 group-hover:opacity-100" />
...
export function RevealLine({ className = "" }: { className?: string }) {
  return (
    <motion.div
      ...
      className={`h-px origin-left bg-linear-to-r from-[#C68A17] to-[#C68A17]/0 ${className}`}
    />
  );
}
    ...
    <div className={className}>
      ...
      <div className="h-2 w-full overflow-hidden rounded-full bg-white/10">
        <motion.div
          ...
          className="h-full rounded-full bg-linear-to-r from-[#C68A17] to-[#A87310]"
        />
      </div>
    </div>
  );
