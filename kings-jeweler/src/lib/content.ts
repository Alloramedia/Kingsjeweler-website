...
export const blogPosts: BlogPost[] = [
  /* ── 1. Ring resizing cost — high-intent repair keyword ─────────── */
  {
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          "Full eternity bands — stones all the way around — generally can't be resized because there's no bare metal to cut. Tungsten, titanium, and stainless steel rings can't be resized at all; those metals can't be soldered like gold or platinum, so the fix is usually exchanging for the correct size.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "If you're in the Greater Hartford area, stop by King's Jeweler inside The Shoppes at Buckland Hills in Manchester — most simple resizes are done while you shop. See everything we handle on our [jewelry services page](/services), or [contact us](/contact) with a photo of your ring for a ballpark estimate.",
        ],
      },
    ],
    related: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Not when done properly. A skilled jeweler solders the joint so it's as strong as the original band and polishes it invisible. Repeated resizing of the same ring, however, is best avoided — get your size measured professionally first.",
      },
    ],
  },
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Decide your ceiling before you shop, and tell the jeweler. A good one will show you the best ring at your number, not push you past it. At an independent store you're also not paying mall-chain markup or national ad budgets — the same stone often costs meaningfully less than at a big-box brand.",
        ],
      },
      {
  ...
  /* ── 3. Lab-grown vs natural — high-volume comparison keyword ───── */
  {
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          "Natural diamonds hold meaningful resale and trade-in value — typically 25–50% of retail, more for exceptional stones — because supply is finite. Lab-grown prices have fallen steadily as production scales, and their resale value is minimal. Buy a lab diamond for its beauty, not as a store of value.",
  ...
  /* ── 4. Selling gold — high-intent local commercial keyword ─────── */
  {
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          "Look inside rings and on chain clasps for karat stamps: 10k means 41.7% pure gold, 14k is 58.3%, 18k is 75%, and 24k is pure. European pieces may read 417, 585, or 750 — same thing. \"GF\" or \"GP\" means gold-filled or gold-plated, which has little melt value.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "No buyer pays 100% of melt — refining costs and margin are real — but reputable local buyers pay 70–90% of melt for common gold. If someone offers you $200 for that $495 chain, walk out.",
        ],
      },
      {
  ...
  /* ── 5. Watch battery — local same-day intent ───────────────────── */
  {
    ...
    body: [
      {
        paragraphs: [
          "A stopped watch is one of those errands people put off for months — then the fix takes five minutes. We replace watch batteries all day at our store in The Shoppes at Buckland Hills, so here's everything worth knowing: what it costs, how long batteries last, and why where you go matters more than people think.",
        ],
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "It can if done carelessly. Opening the case disturbs the gasket seal, so ask for the gasket to be checked or replaced and the caseback properly pressed or torqued — standard practice at a good jeweler, rare at kiosks.",
      },
      {
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "This is why an insurance appraisal is not an offer to buy, and why the number on your appraisal isn't what a buyer will pay. Knowing which value you need prevents both disappointment and paperwork problems — tell the appraiser the purpose up front.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "King's Jeweler provides written appraisals for insurance, estates, and personal knowledge at our store in The Shoppes at Buckland Hills in Manchester. Bring any paperwork you have — old receipts, grading reports, prior appraisals — and we'll handle the rest. [See our appraisal services](/services) or [get in touch](/contact) to plan a visit. Thinking of selling instead of insuring? Read our [guide to selling gold](/blog/how-to-sell-gold-jewelry) first.",
        ],
      },
    ],
    related: [
  ...
  /* ── 7. Cleaning gold — evergreen how-to traffic ────────────────── */
  {
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          "Diamonds, sapphires, and rubies are durable and handle soapy scrubbing easily. Softer or porous gems need gentler care: pearls should only be wiped with a slightly damp cloth (never soaked — it degrades the silk stringing and nacre), opals hate heat and dryness, and emeralds are usually oil-treated, so hot water and ultrasonics can leave them looking dull and dry.",
    ...
    faqs: [
      {
        ...
        answer:
          "Warm water with a few drops of plain dish soap. Soak for 15–20 minutes, scrub gently with a soft toothbrush, rinse in clean water, and pat dry. Avoid toothpaste, baking soda, and bleach — all can damage gold or stones.",
      },
      {
